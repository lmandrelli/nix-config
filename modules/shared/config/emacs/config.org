...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Luca Mandrelli"
    user-mail-address "luca.mandrelli@icloud.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/lmandrelli/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/lmandrelli/bin" "/profile/bin" "/Users/lmandrelli/.npm-packages/bin" "/Users/lmandrelli/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
